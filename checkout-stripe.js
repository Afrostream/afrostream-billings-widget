...
(function () {
  var namespace = "AfrostreamCheckout.require".split("."),
...
AfrostreamCheckout.require.define({
...
AfrostreamCheckout.require.define({
  "lib/optionHelpers": function (exports, require, module) {
    (function () {
      var BOOLEAN, OPTIONAL, OPTIONS, PRIVATE, RECOMMENDED, REQUIRED, REQUIRED_OPTIONS, STRING, SUGGESTABLE_OPTIONS, URL, flatten, ignore, isBoolean, isNumber, isString, opt, option, optsettings, repr, simpleTypeCheck, truncate, val;
      ...
      simpleTypeCheck = function (expectedType, val) {
        ...
        if (actualType !== expectedType) {
          return {
            errorMsg: "Looking for type '" + expectedType + "', but instead we found '" + actualType + "'."
          }
        }
      };
        ...
        alipay: {
          ...
          spec: function (val) {
            ...
            if (type !== "boolean" && val !== "auto") {
              return {
                errorMsg: "The 'alipay' option can be true, false, or 'auto', " + ("but instead we found " + truncate(repr(val), 50) + ".")
              }
            }
          }
        },
      ...
      for (option in OPTIONS) {
        ...
        switch (optsettings.coerceTo) {
          case STRING:
            optsettings.spec = isString;
            break;
          case URL:
            optsettings.spec = isString;
            break;
          case BOOLEAN:
            optsettings.spec = isBoolean;
            break;
          default:
            optsettings.spec = ignore
        }
      }
      REQUIRED_OPTIONS = function () {
        ...
        for (opt in OPTIONS) {
          val = OPTIONS[opt];
          if (val.importance === REQUIRED) {
            _results.push(opt)
          }
        }
        return _results
      }();
      SUGGESTABLE_OPTIONS = function () {
        var _results;
        _results = [];
        for (opt in OPTIONS) {
          val = OPTIONS[opt];
      ...
      module.exports = {
        ...
        SUGGESTABLE_OPTIONS: SUGGESTABLE_OPTIONS,
        OPTIONAL: OPTIONAL,
        RECOMMENDED: RECOMMENDED,
        REQUIRED: REQUIRED,
        PRIVATE: PRIVATE,
...
AfrostreamCheckout.require.define({
  "lib/optionParser": function (exports, require, module) {
    (function () {
      var CHECKOUT_DOCS_URL, ErrorMissingRequired, ErrorMisspelledRequired, OptionsValid, WarnMisspelledOptional, WarnOptionTypeError, WarnUnrecognized, checkOptionTypes, checkRequiredOptions, checkUnrecognizedOptions, extractValue, helpers, isLiveModeFromKey, optionHelpers, spellChecker, toBoolean, trackError, trackSummary, trackWarning, tracker, validateOptions, _trackIndividual, __indexOf = [].indexOf || function (item) {
      ...
      OptionsValid = function () {
        ...
        OptionsValid.prototype.toString = function () {
          return "OptionsValid"
        };
        OptionsValid.prototype.trackedInfo = function () {
          return {
            result: "OptionsValid"
          }
        };
      ...
      ErrorMissingRequired = function () {
        function ErrorMissingRequired (key) {
          this.key = key
        }

        ErrorMissingRequired.prototype.toString = function () {
          return "'" + this.key + "' is a required option, but was not found.\nYou can learn about this option in the Checkout docs:\n" + CHECKOUT_DOCS_URL
        };
      ...
      ErrorMisspelledRequired = function () {
        function ErrorMisspelledRequired (expected, actual) {
          this.expected = expected;
          this.actual = actual
        }

        ErrorMisspelledRequired.prototype.toString = function () {
          return "Unrecognized option '" + this.actual + "'. Did you mean '" + this.expected + "'? ('" + this.expected + "' is required)\nYou can learn about the available options in the Checkout docs:\n" + CHECKOUT_DOCS_URL
        };
      ...
      WarnMisspelledOptional = function () {
        function WarnMisspelledOptional (expected, actual) {
          this.expected = expected;
          this.actual = actual
        }

        WarnMisspelledOptional.prototype.toString = function () {
          return "Unrecognized option '" + this.actual + "'. Did you mean '" + this.expected + "'?\nYou can learn about the available options in the Checkout docs:\n" + CHECKOUT_DOCS_URL
        };
      ...
      WarnUnrecognized = function () {
        function WarnUnrecognized (key) {
          this.key = key
        }

        WarnUnrecognized.prototype.toString = function () {
          return "Unrecognized option '" + this.key + "'.\nYou can learn about the available options in the Checkout docs:\n" + CHECKOUT_DOCS_URL
        };
      ...
      WarnOptionTypeError = function () {
        function WarnOptionTypeError (key, errorMsg) {
          this.key = key;
          this.errorMsg = errorMsg
        }

        WarnOptionTypeError.prototype.toString = function () {
          return "Type mismatch for option '" + this.key + "':\n" + this.errorMsg + "\nYou can learn about the configuration options in the Checkout docs:\n" + CHECKOUT_DOCS_URL
        };
      ...
      extractValue = function (raw, key) {
        var dashed, downcased;
        if (raw[key] != null) {
          return raw[key]
        }
        downcased = key.toLowerCase();
        if (raw[downcased] != null) {
          return raw[downcased]
        }
        dashed = key.replace(/([A-Z])/g, function (g) {
      ...
      checkRequiredOptions = function (_arg, options) {
        var maybe_error, reqOpt, warnings, _i, _len, _ref;
        maybe_error = _arg.maybe_error, warnings = _arg.warnings;
        _ref = optionHelpers.REQUIRED_OPTIONS;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          reqOpt = _ref[_i];
          if (!(reqOpt in options)) {
            maybe_error = new ErrorMissingRequired(reqOpt);
            break
          }
        }
        return {
      ...
      checkUnrecognizedOptions = function (_arg, options) {
        var THRESHOLD, maybe_error, option, suggestion, warnings;
        maybe_error = _arg.maybe_error, warnings = _arg.warnings;
        THRESHOLD = 4;
        for (option in options) {
          if (!(option in optionHelpers.OPTIONS)) {
            suggestion = spellChecker.suggest(optionHelpers.SUGGESTABLE_OPTIONS, option, THRESHOLD);
            if (__indexOf.call(optionHelpers.REQUIRED_OPTIONS, suggestion) >= 0) {
              if (maybe_error instanceof ErrorMissingRequired) {
                maybe_error = new ErrorMisspelledRequired(suggestion, option);
                break
              } else {
                warnings.push(new WarnUnrecognized(option))
              }
            } else if (suggestion != null) {
              warnings.push(new WarnMisspelledOptional(suggestion, option))
            } else {
              warnings.push(new WarnUnrecognized(option))
            }
          }
      ...
      checkOptionTypes = function (_arg, raw) {
        var error, errorMsg, filtered, maybe_error, option, val, warnings;
        maybe_error = _arg.maybe_error, warnings = _arg.warnings;
        filtered = {};
        for (option in raw) {
          val = raw[option];
        ...
        for (option in filtered) {
          val = filtered[option];
          error = optionHelpers.OPTIONS[option].spec(val);
          if (!error) {
            continue
          }
          errorMsg = error.errorMsg;
          warnings.push(new WarnOptionTypeError(option, errorMsg))
        }
        return {
          maybe_error: maybe_error,
          warnings: warnings
      ...
      validateOptions = function (raw) {
        var maybe_error, warnings, _ref, _ref1, _ref2;
        _ref = checkRequiredOptions({
          maybe_error: new OptionsValid,
          warnings: []
        }, raw), maybe_error = _ref.maybe_error, warnings = _ref.warnings;
        _ref1 = checkUnrecognizedOptions({
          maybe_error: maybe_error,
          warnings: warnings
        }, raw), maybe_error = _ref1.maybe_error, warnings = _ref1.warnings;
        if (!(maybe_error instanceof OptionsValid)) {
          return {
            maybe_error: maybe_error,
            warnings: []
          }
        ...
        _ref2 = checkOptionTypes({
          maybe_error: maybe_error,
          warnings: warnings
        }, raw), maybe_error = _ref2.maybe_error, warnings = _ref2.warnings;
        if (!(maybe_error instanceof OptionsValid)) {
          return {
            maybe_error: maybe_error,
            warnings: []
      ...
      _trackIndividual = function (level, origin, error) {
        ...
        switch (level) {
          case "error":
            tracker.track.configError(parameters);
            break;
          case "warning":
            tracker.track.configWarning(parameters)
        }
      };
      trackSummary = function (parameters) {
        ...
        return tracker.track.configSummary(prefixedParams)
      };
      trackError = function (origin, error) {
        return _trackIndividual("error", origin, error)
      };
      trackWarning = function (origin, error) {
        return _trackIndividual("warning", origin, error)
      };
      module.exports = {
        ...
        parse: function (raw) {
          var BOOLEAN, STRING, URL, opt, optsettings, parsed, val, _ref;
          if (raw == null) {
            raw = {}
          }
          parsed = {};
          _ref = optionHelpers.OPTIONS;
          for (opt in _ref) {
            optsettings = _ref[opt];
            val = extractValue(raw, opt);
            if (val == null && optsettings["default"] != null) {
              val = optsettings["default"]
            }
            BOOLEAN = optionHelpers.BOOLEAN, STRING = optionHelpers.STRING, URL = optionHelpers.URL;
            switch (optsettings.coerceTo) {
              case BOOLEAN:
                if (val != null) {
                  parsed[opt] = toBoolean(val)
                }
                break;
              case STRING:
                if (val != null) {
              ...
              case URL:
                if (val != null) {
                  parsed[opt] = helpers.sanitizeURL(val)
                }
                break;
              default:
                parsed[opt] = val
          ...
          if (parsed.alipay != null && parsed.alipay !== "auto") {
            parsed.alipay = toBoolean(parsed.alipay)
          }
          if (parsed.shippingAddress) {
            parsed.billingAddress = true
          }
          if (raw.address != null && raw.address !== "false" && raw.address !== false) {
            parsed.billingAddress = true
          }
        ...
        checkUsage: function (origin, raw, isDarkMode) {
          var isButtonIntegration, isLiveMode, maybe_error, numWarnings, quiet, warning, warnings, _i, _len, _ref;
          isLiveMode = isLiveModeFromKey(raw.key);
          isButtonIntegration = !!raw.buttonIntegration;
          if (isButtonIntegration) {
            return
          }
          quiet = isLiveMode || isDarkMode || isButtonIntegration;
          _ref = validateOptions(raw), maybe_error = _ref.maybe_error, warnings = _ref.warnings;
          numWarnings = warnings.length;
          if (maybe_error instanceof OptionsValid && numWarnings === 0) {
            trackSummary({
              origin: origin,
              numErrors: 0,
              numWarnings: numWarnings
            })
          } else if (!(maybe_error instanceof OptionsValid)) {
            if (!quiet) {
              if (typeof console !== "undefined" && console !== null) {
                console.error("AfrostreamCheckout: " + maybe_error.toString())
              }
            }
            trackSummary({
              origin: origin,
            ...
            for (_i = 0, _len = warnings.length; _i < _len; _i++) {
              ...
              if (!quiet) {
                if (typeof console !== "undefined" && console !== null) {
                  console.warn("AfrostreamCheckout: " + warning.toString())
                }
              }
              trackWarning(origin, warning)
            }
          }
        }
      }
    ...
    (function () {
      ...
      App = function () {
        ...
        App.prototype.open = function (options, buttonId) {
          var checkout, isDarkMode, k, mergedOptions, v, _ref;
          if (options == null) {
            options = {}
          }
          if (buttonId == null) {
          ...
          isDarkMode = true;
          optionParser.checkUsage("open", mergedOptions, isDarkMode);
        ...
        App.prototype.configure = function (buttonId, options) {
          ...
          isDarkMode = true;
          optionParser.checkUsage("configure", options, isDarkMode);
          if (options.image) {
        ...
        App.prototype.validateOptions = function (options, which) {
          ...
          try {
            ...
            throw new Error("Stripe Checkout was unable to serialize the options passed to AfrostreamCheckout." + which + "(). Please consult the doumentation to confirm that you're supplying values of the expected type: " + url)
          }
        };
      ...
      Checkout = function () {
        ...
        Checkout.prototype.createView = function (useManhattan) {
          ...
          if (helpers.isFallback()) {
            ...
            path = "/v3/fallback/Yj7mlBHEsEeFPhzGOklANg.html"
          } else {
            if (this.shouldPopup) {
              viewClass = TabView
            } else {
            ...
            if (useManhattan) {
              path = "/m/v3/index-85895eb1253e205fbd1d.html"
            } else {
              path = "/checkout-form.html"
            }
          }
          ...
          cb = function (_this) {
            return function () {
              ...
              iframeFallback = function () {
                ...
                this.view = new IframeView(this.onToken, this.host, "/v3/VguVZoYKogJUsO05PpIlfA.html");
...
(function () {
  ...
  require = require || this.AfrostreamCheckout.require;
  Button = require("outer/controllers/button");
  App = require("outer/controllers/app");
  if (((_ref = this.AfrostreamCheckout) != null ? _ref.__app : void 0) == null) {
    this.AfrostreamCheckout || (this.AfrostreamCheckout = {});
    this.AfrostreamCheckout.__app = app = new App;
    this.AfrostreamCheckout.open = app.open;
    this.AfrostreamCheckout.configure = app.configure;
    this.StripeButton = this.AfrostreamCheckout;
    if (((_ref1 = this.AfrostreamCheckout) != null ? _ref1.__forceManhattan : void 0) != null) {
      app.setForceManhattan(this.AfrostreamCheckout.__forceManhattan)
    }
    if (((_ref2 = this.AfrostreamCheckout) != null ? _ref2.__host : void 0) && this.AfrostreamCheckout.__host !== "") {
      app.setHost(this.AfrostreamCheckout.__host)
    }
  }
  Button.load(this.AfrostreamCheckout.__app)
}).call(this);
